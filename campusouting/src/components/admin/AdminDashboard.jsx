...
export default function AdminDashboard() {
    ...
    const S = {
        ...
        tabs: { display: "flex", flexWrap: "wrap", gap: 2, padding: "16px clamp(16px, 4vw, 32px) 0", borderBottom: "1px solid rgba(148,163,184,0.08)" },
        tab: (active) => ({
        ...
        content: { padding: "clamp(16px, 4vw, 28px) clamp(16px, 4vw, 32px)" },
        sectionTitle: {
